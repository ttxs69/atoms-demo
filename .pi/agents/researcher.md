...
**If web tools are unavailable, say so in the first line and stop.** Do not substitute model recall
for fetched evidence. A brief built on recollection is worse than no brief, because it looks complete.
